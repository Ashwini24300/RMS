...
//	private PasswordResetTokenRepository passwordResetTokenRepository;
	...
	public CustomerDto findCustomerByEmailAndPassword(Credentials cred) {
		Customer cust = customerDao.findByEmail(cred.getEmail()).orElseThrow(()-> new ResourceNotFoundException("invalid email id"));
	...
	public CustomerDto findCustomerByEmail(String email) {
		...
		Customer cust = customerDao.findByEmail(email).orElseThrow(()-> new ResourceNotFoundException("invalid email id"));
		if(cust == null) {
			return null;
		}
		CustomerDto customerDto = new CustomerDto();
